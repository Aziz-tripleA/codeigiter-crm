                        ...
                        <div class="panel-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="<?php echo base_url();?>admin/Setup_controller/delete_section/<?php echo html_escape($value->ms_id);?>" onclick="return confirm('<?php echo display('delete_alert')?>');" class="btn btn-xs btn-danger">
