            ...
            <div  class="panel panel-default panel-form">
                ...
                <div class="panel-heading ">
                        <div class="panel-title" >
                            <h4> Edit <?php echo display('schedule');?></h4>
                        </div>
                   </div>
                    ...
                    <div class="portlet-body form">
                        <?php 
                          $mag = $this->session->userdata('message');
                           if($mag){
                               echo "<div class='alert alert-success msg'>".htmlspecialchars_decode($mag)."</div><br>";
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-group  input-daterange">
                                    ...
                                    <div class="input-group ">
                                        <input type="text" class="form-control" id="basic_example_1"  autocomplete="off"  value="<?php echo html_escape($schedul_info->start_time);?>"  name="s_time">
                                    ...
                                    <div class="input-group ">
                                        <input type="text" class="form-control" id="basic_example_2"  autocomplete="off" value="<?php echo html_escape($schedul_info->end_time);?>" name="e_time" >
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-time"></span>
                                        </span>
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"><span class="text-danger">*</span> Select Doctor :</label>
                                <div class="col-md-5">
                                    <select class="form-control" required name="doctor_id">
                                        <option value="">--select doctor--</option>
                                        <?php foreach($doctor as $value){
                                            echo '<option value="'.html_escape($value->doctor_id).'" '.(html_escape($schedul_info->doctor_id)==html_escape($value->doctor_id)?'selected':'').'>'.html_escape($value->doctor_name).'</option>';
                                        }?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="checkbox2_5" value="1"  autocomplete="off" name="visible" <?php echo ($schedul_info->visibility=='1')?'checked':'' ?>  value="1" class="md-radiobtn">
                                            ...
                                            <div class="md-radio">
                                                <input type="radio" id="checkbox2_10" value="0"  autocomplete="off" name="visible"  <?php echo ($schedul_info->visibility=='0')?'checked':'' ?> value="0" class="md-radiobtn">
