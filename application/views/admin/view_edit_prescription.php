                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="portlet-title">
                                         <div class="form-group ">
                                            ...
                                            <div class="col-md-3"><input type="text" class="form-control" value="<?php echo html_escape(@$pres->weight);?>"  placeholder="<?php echo display('patient_weight')?>" name="Weight" value=""/></div> 
                                            <div class="col-md-3"><input type="text" class="form-control" value="<?php echo html_escape(@$pres->temperature);?>" placeholder="<?php echo display('temperature')?>" name="temperature"  value=""/></div>
                                        </div>
                                    </div><hr/>
...
<?php $this->load->view('admin/admin_script/edit_prescription.php');?>
