            ...
            <div  class="panel panel-bd panel-form">
                ...
                <div class="panel-heading ">
                        <div class="panel-title">
                            <h4><?php echo display('email_schedule_stup');?></h4>
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                       <select class="form-control" name="template_id" required="1" >
                                            ...
                                            <option value="<?php echo html_escape($value1->email_temp_id)?>"><?php echo html_escape($value1->email_temp_name);?></option>
                                            <?php }?>
                                        </select>
                                   </div>
                                </div>
    ...
    <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bd">
                    ...
                    <div class="panel-heading ">
                        <div class="panel-title">
                            <h4><?php echo display('email_schedule_stup_list');?></h4>
                        </div>
                    </div>
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo html_escape($value->email_schedule);?></td>
                                    
                                    <td class="text-right">
                                        <a href="<?php echo base_url();?>admin/email/Email/delete_schedule/<?php echo html_escape($value->email_ss_id) ;?>" onclick="return confirm('Are you want to delelte?');" class="btn btn-xs btn-danger">
