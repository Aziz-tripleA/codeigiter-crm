            ...
            <div class="panel panel-bd">
                <div class="panel-heading ">
                        <div class="panel-title">
                            <h4><?php echo display('email_template_list_of_app');?></h4>
                        </div>
                    </div>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php foreach($template_a as $value){?>
                                <tr>
                                    <td> 
                                        <a class="btn btn-info" href="<?php echo base_url(); ?>admin/email/Email/set_default_template/<?php echo html_escape($value->email_temp_id) . '/' . html_escape($value->default_status); ?>"><span class="glyphicon glyphicon-<?php echo html_escape($value->default_status)==1?'ok':'remove';?>"></span></a>
                                    </td>
                                    <td><?php echo html_escape($value->email_temp_name);?></td>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading ">
                        <div class="panel-title">
                            <h4><?php echo display('email_template_list_of_reg');?></h4>
                        </div>
                    </div>
                <div class="panel-body">
                            ...
                            <tbody>
                                <?php foreach($template_r as $value){?>
                                    <tr>
                                       ...
                                       <td><?php if($value->set_default==0){?>
                                            <a href="<?php echo base_url();?>admin/email/Email/get_email_template/<?php echo html_escape($value->email_temp_id);?>" class="btn btn-warning">Edit</a>
