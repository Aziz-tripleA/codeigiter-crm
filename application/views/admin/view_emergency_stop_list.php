                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            ...
                                            <a href="<?php echo base_url();?>admin/Emergency_stop_controller/delete_emergency_stop/<?php echo html_escape($value->stop_id);?>" onclick="return confirm('Are you want to delelte?');" class="btn  btn-xs btn-danger">
