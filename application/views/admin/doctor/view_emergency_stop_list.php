                        ...
                        <div class="table-responsive order-table">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <a href="<?php echo base_url();?>admin/doctor/Emergency_stop_controller/edit_emergency_stop/<?php echo html_escape($value->stop_id);?>" class="btn  btn-xs btn-info">
                                            <i class="fa fa-edit"></i> </a>
                                            <a href="<?php echo base_url();?>admin/doctor/Emergency_stop_controller/delete_emergency_stop/<?php echo html_escape($value->stop_id);?>" onclick="return confirm('Are you want to delelte?');" class="btn  btn-xs btn-danger">
