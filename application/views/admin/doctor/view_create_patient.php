                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input type="text" name="title" class="form-control" value="<?php echo html_escape(@$old->title);?>" > 
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input type="text" name="family_name" class="form-control" value="<?php echo html_escape(@$old->family_name);?>" required> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input type="text" name="given_name" class="form-control" value="<?php echo html_escape(@$old->given_name);?>" > 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class=" ">
                                       <input type="text" name="birth_date" value="<?php echo html_escape(@$old->birth_date);?>" class="form-control datepicker1 birth_date">
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input type="email" name="email" class="form-control" value="<?php echo html_escape(@$old->email);?>"> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input type="number"  name="phone" value="<?php echo html_escape(@$old->phone);?>" class="form-control" required > 
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div >
                                        <input type="number"  name="mobile_number" value="<?php echo html_escape(@$old->mobile_number);?>" class="form-control" required> 
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label class="control-label"> <?php echo display('title');?> </label>
                                        <div class="">
                                            <input type="text" name="emg_title" value="<?php echo html_escape(@$old->emg_title);?>" class="form-control"> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="">
                                            <input type="text" name="emg_family_name" class="form-control" value="<?php echo html_escape(@$old->emg_family_name);?>"> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label class="control-label"> <?php echo display('given_name');?></label>
                                        <div class="">
                                            <input type="text" name="emg_given_name" class="form-control" value="<?php echo html_escape(@$old->emg_given_name);?>"> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label class=" control-label"><span class="text-danger">*</span> <?php echo display('mobile');?></label>
                                        <div >
                                            <input type="text"  name="emg_mobile" value="<?php echo html_escape(@$old->emg_mobile);?>" class="form-control" required > 
