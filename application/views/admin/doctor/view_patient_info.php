                ...
                <div class="review-block">
                    <div class="row">
                        <div class="col-sm-3" >
                            ...
                            <div class="review-block-name"><a href="#"><?php echo html_escape(@$patient_info->family_name) .' '. html_escape(@$patient_info->given_name) ;?></a></div>
                            <div class="review-block-date"><?php echo html_escape($patient_info->birth_date);?></div>
                           
                        </div>

                        <div class="col-sm-9">
                            <div class="review-block-title"><?php echo html_escape(@$patient_info->family_name) .' '. html_escape(@$patient_info->given_name) ;?></div>
