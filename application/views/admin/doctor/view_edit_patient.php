                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input type="number" name="phone" value="<?php echo html_escape(@$patient_info->patient_phone);?>" class="form-control" required placeholder="<?php echo display('phone_number'); ?>"> 
