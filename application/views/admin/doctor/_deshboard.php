                            ...
                            <a href="<?php echo base_url();?>admin/doctor/Patient_controller/patient_list">
                                <div class="panel-body">
                                    <div class="statistic-box">
                                        <h2><span class="count-number"><?php echo html_escape(count(@$total_patient))?></span> </h2>
...
<script src="http://localhost/clinic365-Main/assets/plugins/chartJs/Chart.min.js" type="text/javascript"></script>
