                        ...
                        ?>
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><span class="text-danger">*</span><?php echo display('old_password');?></label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><span class="text-danger">*</span><?php echo display('new_password');?></label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><span class="text-danger">*</span><?php echo display('confirm_password');?></label>
                                    <div class="col-md-9">
