                         ...
                         ?>
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="department" value="<?php echo html_escape(@$doctor_info->department); ?>" class="form-control" placeholder="<?php echo display('department');?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <textarea name="about_me" value="<?php echo html_escape($doctor_info->about_me); ?>"  class=" form-control" rows="6"> <?php echo html_escape($doctor_info->about_me); ?> </textarea>
                                    </div>
                                </div>
