                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <?php echo html_escape($invo->doctor_name);?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                ?>
                                    ...
                                    <input type="hidden" name="inv_p_id[]" value="<?php echo html_escape(@$value->inv_p_id);?>">
                                        ...
                                        <td>
                                            <input name="product_name" value="<?php echo html_escape($value->service_name);?>" onkeypress="invoice_productList(<?php echo $i?>);" class="form-control productSelection" placeholder="Service Name" required="" id="product_name" type="text">
                                        ...
                                        <td>
                                            <input name="product_quantity[]" onkeyup="quantity_calculate(<?php echo $i?>);" onchange="quantity_calculate(<?php echo $i?>);" id="total_qntt_<?php echo html_escape($i);?>" class="form-control text-right" value="<?php echo html_escape($value->quantity);?>" min="1" type="number">
                                        </td>

                                        <td>
                                            <input name="product_rate[]" readonly=""  value="<?php echo html_escape($value->price);?>" id="price_item_<?php echo html_escape($i);?>" class="price_item1 form-control text-right" type="text">
                                        </td>

                                        <!-- Discount -->
                                        <td>
                                            <input name="discount[]" onkeyup="quantity_calculate(<?php echo $i?>);" onchange="quantity_calculate(<?php echo $i?>);" id="discount_<?php echo html_escape($i);?>" class="form-control text-right" placeholder="Discount" value="<?php echo html_escape($value->discount);?>" min="0" type="number">
                                        </td>
                                       
                                        <td>
                                            <input class="total_price form-control text-right" name="total_price[]" id="total_price_<?php echo html_escape($i);?>" value="<?php echo html_escape($value->grand_price);?>" tabindex="-1" readonly="readonly" type="text">
                                        </td>

                                         <td>
                                            <!-- Tax calculate start-->
                                            <input id="total_tax_<?php echo html_escape($i);?>" class="total_tax_1" value="<?php echo html_escape($value->tax);?>" type="hidden">
                                            <input id="all_tax_<?php echo html_escape($i);?>" class="total_tax" value="<?php echo html_escape($value->tax);?>" type="hidden">
                                            <!-- Tax calculate end -->
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea name="payment_notes" class="form-control" placeholder="<?php echo display('payment_notes')?>"><?php echo html_escape($invo->payment_notes);?></textarea>
                                    </div>
                                </div>
