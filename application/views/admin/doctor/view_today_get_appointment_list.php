                ...
                <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="appointment">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo html_escape($value->family_name);?></td>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-xs btn-primary" data-original-title="View Prescription" target="_blank" href="<?php echo base_url();?>admin/doctor/Prescription_controller/create_prescription/<?php echo html_escape($value->appointment_id); ?>"><i class="fa fa-user"></i></a>   
