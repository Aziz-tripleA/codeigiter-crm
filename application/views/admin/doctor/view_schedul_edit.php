                ...
                <div class="panel-body">
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group  input-daterange">
                                        ...
                                        <div class="input-group ">
                                            <input type="text" class="form-control" id="basic_example_1"  value="<?php echo html_escape($schedul_info->start_time);?>"  name="s_time">
                                        ...
                                        <div class="input-group ">
                                            <input type="text" class="form-control" id="basic_example_2" value="<?php echo html_escape($schedul_info->end_time);?>" name="e_time" >
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-time"></span>
                                            </span>
                                        </div>
                           ...
                           <input type="hidden" value="<?php echo html_escape($schedul_info->start_time);?>" name="doctor_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <select class="form-control" name="day" id="day" onchange="loadError(this.value);">
                                            ...
                                            <option value='1' <?php echo ($schedul_info->day=='1'?'selected':'');?>><?php echo display('saturday');?></option>
                                            <option value='2' <?php echo ($schedul_info->day=='2'?'selected':'');?>><?php echo display('sunday');?></option>
                                            <option value='3' <?php echo ($schedul_info->day=='3'?'selected':'');?>><?php echo display('monday');?></option>
                                            <option value='4' <?php echo ($schedul_info->day=='4'?'selected':'');?>><?php echo display('tuesday');?></option>
                                            <option value='5' <?php echo ($schedul_info->day=='5'?'selected':'');?>><?php echo display('wednesday');?></option>
                                            <option value='6' <?php echo ($schedul_info->day=='6'?'selected':'');?>><?php echo display('thusday');?></option>
                                            <option value='7' <?php echo ($schedul_info->day=='7'?'selected':'');?>><?php echo display('friday');?></option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class=" input-daterange">
                                        <input type="number" name="p_time" value="<?php echo html_escape($schedul_info->per_patient_time);?>" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="checkbox2_5" value="1" name="visible" <?php echo (html_escape($schedul_info->visibility)=='1')?'checked':'' ?>  value="1" class="md-radiobtn">
