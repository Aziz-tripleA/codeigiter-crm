                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> 
                                        <a class="btn btn-info" href="<?php echo base_url(); ?>admin/Sms_setup_controller/set_default_template/<?php echo html_escape($value->teamplate_id) . '/' . html_escape($value->default_status); ?>"><span class="glyphicon glyphicon-<?php echo html_escape($value->default_status)==1?'ok':'remove';?>"></span></a>
                                    </td>
                                    ...
                                    <td class="text-right">
                                        <a onclick="js_value(<?php echo html_escape($value->teamplate_id);?>)" class="btn btn-xs btn-warning">
