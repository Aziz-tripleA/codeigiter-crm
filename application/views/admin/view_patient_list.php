                           ...
                           <?php
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="">
                                    ...
                                    <a  class="btn btn-xs btn-success" href="<?php echo base_url();?>admin/Patient_controller/patient_info/<?php echo html_escape($value->patient_id) ;?>" > <i class="fa fa-eye"></i> </a>
