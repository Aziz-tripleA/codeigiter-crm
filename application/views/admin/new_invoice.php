                        ...
                        <div class="row">
                        	<div class="col-sm-6" >
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input required="" autocomplete="off" name="phone" id="phone" class="form-control" type="number" required="
                                        ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input required="" name="address" id="address" class="form-control" type="text" required="">
                                    </div>
                                </div>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="product_quantity[]" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);" id="total_qntt_1" class="form-control text-right" value="1" min="1" type="number">
                                        </td>
                                        ...
                                        <!-- Discount -->
                                        <td>
                                            <input name="discount[]" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);" id="discount_1" class="form-control text-right" placeholder="Discount" value="0.00" min="0" type="number">
                                        </td>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            ...
                                            <!-- Tax calculate end -->
                                            <button  class="btn btn-danger" type="button" value="<?php echo display('delete')?>" onclick="deleteRow(this)"><?php echo display('delete')?></button>
                                        </td>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3"><b><?php echo display('due')?>:</b></td>
                                        <td class="text-right">
