                           ...
                           <?php
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="">
                                    ...
                                    <a  class="btn btn-xs btn-danger" href="<?php echo base_url();?>admin/Patient_controller/delete_patient/<?php echo html_escape($value->patient_id) ;?>"  onclick="return confirm('<?php echo display('delete_alert')?>')">
