                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input type="number"   required name="national_id" class="form-control" value="<?php echo html_escape(@$old->nationl_id);?>"  placeholder="National Id" > 
                                    </div>
                                </div>

                                <div class="form-group col-md-4">
                                    <label class=" control-label"><span class="text-danger">*</span> <?php echo display('title')?> </label>
                                    <div class="">
                               ...
                               <!--  <div class="form-group col-md-4">
                                    <label class="control-label"><span class="text-danger">*</span> <?php echo display('family_name')?></label>
                                    <div class="">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" name="given_name" placeholder="Given Name" > 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label class=" control-label"> <span class="text-danger">*</span><?php echo display('sex'); ?></label>
                                    <div class="">
                            ...
                            <div class="row">
                              ...
                              <!--   <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input type="email" onkeyup="load_patient_id()" id="patient_id" name="email" class="form-control" value="<?php echo html_escape(@$old->email);?>" placeholder="<?php echo display('email'); ?>" required=""> 
                                    </div>
                                </div>
 -->
                                <div class="form-group col-md-4">
                                    <label class=" control-label"> <span class="text-danger">*</span> <?php echo 'mobile number 1'; ?></label>
                                    <div class="">
                                        <input type="number"  name="patient_phone" value="<?php echo html_escape(@$old->phone);?>" class="form-control"  placeholder="<?php echo display('phone_number'); ?>"> 
                                        <span class="text-danger"><?php echo form_error('phone'); ?></span>
                                    </div>
                                </div>

                                <div class="form-group col-md-4">
                                    <label class=" control-label"> <span class="text-danger">*</span> <?php echo 'mobile number 2'; ?></label>
                                    <div class="">
                                        <input type="number"  name="mobile_number" value="<?php echo html_escape(@$old->mobile_number);?>" class="form-control"  placeholder="<?php echo display('phone_number'); ?>"> 
                                        <span class="text-danger"><?php echo form_error('phone'); ?></span>
                                    </div>
                                </div>
                                    ...
                                    <div >
                                        <select name="city" class="form-control" required="">
                                            ...
                                            foreach ($cities as $city) {
                                                ?>
                                            <option value="<?= $city->id ?>"><?= $city->$lang ?></option>
                                            <?php
                                            }
                           ...
                           <div class="row">
                               ...
                               <div class="form-group col-md-4">
                                <label class="control-label"><span class="text-danger">*</span> <?php echo display('address'); ?></label>
                                    <div class="">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label class="control-label"><span class="text-danger">*</span> <?php echo display('family_name'); ?></label>
                                        <div class="">
                                            <input type="text" name="emg_family_name" class="form-control" value="<?php echo html_escape(@$old->emg_family_name);?>"  placeholder="Family Name" required=""> 
                                        </div>
                                    </div>
<!-- 
                                    <div class="form-group col-md-4">
 ...
 -->
                                    ...
                                    <div class="form-group col-md-4">
                                        <label class=" control-label"><span class="text-danger">*</span><?php echo display('phone_number'); ?></label>
                                        <div class="">
                                            <input type="number"  name="emg_phone" value="<?php echo html_escape(@$old->emg_phone);?>" class="form-control" required="" placeholder="Phone Number"> 
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div >
                                            <input type="number"  name="emg_mobile" value="<?php echo html_escape(@$old->emg_mobile);?>" class="form-control" required="" placeholder="Mobile Number" > 
