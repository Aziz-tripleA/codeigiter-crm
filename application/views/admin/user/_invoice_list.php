                                ...
                                <tbody> 
                                    <?php $i=1; foreach($invo as $value){?> 
                                        <tr >
                                            ...
                                            <td class="center">
                                                <a href="<?php echo base_url();?>admin/user/Invoice/invoice_view/<?php echo html_escape($value->invoice_id);?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                                <a href="<?php echo base_url();?>admin/user/Invoice/edit_invoice/<?php echo html_escape($value->invoice_id);?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a> 
                                                <a href="<?php echo base_url();?>admin/user/Invoice/delete/<?php echo html_escape($value->invoice_id);?>"  onclick="return confirm('<?php echo display('delete_alert')?>')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a> 
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
