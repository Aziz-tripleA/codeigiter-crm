    ...
    <section class="content">
        ...
        ?>
                <div class="panel panel-bd lobidrag">
                    ...
                    <input type="hidden" value="<?php echo html_escape($invo->invoice_id);?>" name="invoice_id">
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                ?>
                                    ...
                                    <input type="hidden" name="inv_p_id[]" value="<?php echo html_escape(@$value->inv_p_id);?>">
                                        ...
                                        <td>
                                            <input name="product_quantity[]" onkeyup="quantity_calculate(<?php echo $i?>);" id="total_qntt_<?php echo html_escape($i);?>" class="form-control text-right" value="<?php echo html_escape($value->quantity);?>" min="1" type="number">
                                        </td>
                                        ...
                                        <!-- Discount -->
                                        <td>
                                            <input name="discount[]" onkeyup="quantity_calculate(<?php echo $i?>);" id="discount_<?php echo html_escape($i);?>" class="form-control text-right" placeholder="Discount" value="<?php echo html_escape($value->discount);?>" min="0" type="number">
                                        </td>
