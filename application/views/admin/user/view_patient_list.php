                        ...
                        <tbody>
                           <?php
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="">
                                    <a  class="btn btn-xs btn-info" href="<?php echo base_url();?>admin/user/Patient_controller/patient_edit/<?php echo html_escape($value->patient_id);?>">
                                    <i class="fa fa-edit"></i> </a>
                                    <a  class="btn btn-xs btn-success" href="<?php echo base_url();?>admin/user/Patient_controller/patient_info/<?php echo html_escape($value->patient_id) ;?>" > <i class="fa fa-eye"></i> </a>
                                    <a  class="btn btn-xs btn-danger" href="<?php echo base_url();?>admin/user/Patient_controller/delete_patient/<?php echo html_escape($value->patient_id) ;?>" onclick="return confirm('Are you want to delelte?');">
