            ...
            <div class="panel panel-bd">
                ...
                <div class="panel-heading ">
                    <div class="panel-title" >
                        <a href="<?php echo base_url();?>admin/user/Patient_controller/create_new_patient" class="btn btn-success pull-right text-white"><?php echo display('add_new_patient')?></a>  
                    ...
                    ?>
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" onkeyup="loadName()" name="phone" id="phone" placeholder="phone nummber" autocomplete="off" class="form-control" required> 
