                                ...
                                <tbody> 
                                    <?php $i=1; foreach($service as $value){?> 
                                        <tr >
                                            ...
                                            <td class="center">
                                                <a href="<?php echo base_url();?>admin/user/Service/delete_service/<?php echo html_escape($value->id);?>" onclick="return confirm('<?php echo display('delete_confirm_msg')?>')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a> 
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
