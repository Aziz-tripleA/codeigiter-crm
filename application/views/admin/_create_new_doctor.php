                         ...
                         ?>
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="degree" class="form-control" required="" placeholder="<?php echo display('degrees');?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="department"  class="form-control" placeholder="<?php echo display('department');?>" required="">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-3 control-label"><span class="text-danger">*</span><?php echo display('specialist');?></label>
                                    <div class="col-md-7">
                                        <input type="text" name="specialist" class="form-control" placeholder="<?php echo display('specialist');?>" required=""> 
                                    </div>
                                </div>
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><span class="text-danger">*</span><?php echo display('service_place');?></label>
                                    <div class="col-md-7">
                                        <input type="text" name="service_place"  class="form-control" placeholder="<?php echo display('service_place');?>" required=""> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="number"   name="phone"  class="form-control" placeholder="<?php echo display('phone_number');?>" required=""> 
