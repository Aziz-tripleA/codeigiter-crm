...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('surgeries_edit'); ?></h1>
            <small><?php echo display('surgeries_edit'); ?></small>
            ...
            <div class="panel panel-bd">
                ...
                <div class="panel-heading ">
                    <div class="panel-title" >
                        <h4><?php echo display('surgeries_edit');?></h4>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <div class="portlet-body form">
                        <?php
                            ...
                            echo form_open('admin/Surgeries_controller/surgery_edit_store', $attributes);
                        ?>
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="">
                                        <input type="text"  name="surgery_title" class="form-control" value="<?php echo html_escape(@$surgery->title);?>"  placeholder="<?= display('surgery_title') ?>" > 
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="patient_id" class="form-control" required="">
                                       ...
                                       foreach ($patients as $patient) {
                                           ?>
                                       <option <?= ($surgery->patient_id == $patient->patient_id )? 'selected': '';  ?>  value="<?= $patient->patient_id ?>"><?= $patient->given_name ?></option>
                                       <?php
                                       }
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="procedure_id" class="form-control" required="">
                                       ...
                                       foreach ($procedures as $procedure) {
                                           ?>
                                       <option <?= ($surgery->procedure_id == $procedure->id )? 'selected':'' ?> value="<?= $procedure->id ?>"><?= $procedure->name ?></option>
                                       <?php
                                       }
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="clinic_id" class="form-control" required="">
                                       ...
                                       foreach ($clinics as $clinic) {
                                           ?>
                                       <option <?= ($surgery->clinic_id == $clinic->id )? 'selected':'' ?> value="<?= $clinic->id ?>"><?= $clinic->clinic_name ?> - <?= $clinic->clinic_address ?></option>
                                       <?php
                                       }
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class=" ">
                                       <input type="text" name="surgery_date" value="<?php echo html_escape(@$surgery->date);?>" class="form-control datepicker1 birth_date"   placeholder="<?php echo display('surgery_date'); ?>" >
                                    </div>
                                ...
                                <label class="control-label"> <?php echo display('surgery_note'); ?></label>
                                    <div class="">
                                        <textarea name="surgery_note"   class="form-control" rows="1" ><?php echo html_escape(@$surgery->note);?></textarea>
                                    </div>
                                </div>
