            ...
            <div class="col-sm-12">
                    <div class="panel panel-bd">
                        ...
                        <div class="panel-heading no-print">
                            <div class="btn-group"> 
                                <a class="btn btn-success pull-right text-white" href="<?php echo base_url();?>admin/Invoice"> <i class="fa fa-plus"></i> <?php echo display('add_new_invoice')?> </a>  
                                ...
                                <tbody> 
                                    <?php $i=1; foreach($invo as $value){?> 
                                        <tr >
                                            ...
                                            <td class="center">
                                                <a href="<?php echo base_url();?>admin/Invoice/invoice_view/<?php echo html_escape($value->invoice_id);?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                                <a href="<?php echo base_url();?>admin/Invoice/edit_invoice/<?php echo html_escape($value->invoice_id);?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a> 
                                                <a href="<?php echo base_url();?>admin/Invoice/delete/<?php echo html_escape($value->invoice_id);?>"  onclick="return confirm('<?php echo display('delete_alert')?>')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a> 
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
