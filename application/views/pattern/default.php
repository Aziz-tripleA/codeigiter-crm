        	...
        	<div class="main-header">
    	        <div class="row header_area">
    	            ...
    	            <div class="hed-2">                      
    	                ...
    	                <a  target="_blank" href="<?php echo base_url();?>History_controller/patient_history/<?php echo html_escape(@$value->patient_id);?>"><?php echo display('patient_history');?></a>
    	            </div>
    	        ...
    	        <div class="row address_area">
    	            <div class="a-one">
    	                <h4 ><?php echo html_escape(@$value->doctor_name);?></h4>
                ...
                <div class="row patient_area">
                    <div class="col-md-12">
                        <h5>
                        <strong> Admission :</strong> <?php echo html_escape(@$ot->admission_date);?>,
                         &nbsp; <strong>Discharge :</strong> 
                         <?php echo html_escape(@$ot->discharge_date);?>
                         &nbsp; <strong> OT Date : </strong> 
                         <?php echo html_escape(@$ot->ot_date);?>

                         &nbsp;<strong>Phone :</strong> <?php echo html_escape(@$value->patient_phone);?>
                        </h5>
                    </div>
                </div>
                <?php } ?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="test" >
                        ...
                        <p> <?php echo html_escape(@$value->ads);?></p>
                        <?php if(!empty($ot)){?>
                        <h4> OT </h4>
                        <p> <?php echo html_escape(@$ot->ot_name);?></p>
                        <h4>Surgon </h4>
                        <p> <?php echo html_escape(@$ot->ot_surgon);?></p>
                        <?php } ?>
                    </div>
		                      ...
		                      <?php } ?>
		                        ...
		                        <?php if(!empty($value->temperature)){?>
		                         <div class="temperature">
		                              <h4><?php echo display('temperature');?> : <?php echo(html_escape($value->temperature?$value->temperature)."<sup>&deg</sup>C":'');?></h4>
