  ...
  public function save_header(){
    ...
    #-----------------------------------------#
      ...
      $data14 = array('name' => 'google_map',
                  'details' => $this->input->post('google_map',TRUE)
                  );
      ...
      $data19 = array('name' => 'twitter_post',
                  'details' => $this->input->post('twitter_post',TRUE)
                  );
    ...
    #-----------------------------------------#
          ...
          if (@$_FILES['footer_picture']['name']){
              ...
              $image = $this->input->post('footer_pic',TRUE);
            }
      ...
      if(!empty($checkDeata20)){
        ...
        $this->db->where('name','footer_picture')
    ...
    #-----------------------------------------#
          ...
          if (@$_FILES['fabicon']['name']){
              ...
              $this->load->library('upload', $config);
                ...
                if (!$this->upload->do_upload('fabicon')){
                  ...
                  $data = $this->upload->data();
                  $imagef = base_url($config['upload_path'].$data['file_name']);


                }
            } else {
                $imagef = $this->input->post('fabicon_pic',TRUE);
            }

    
      //checkPreview fabicon
      $checkDeata20 = $this->web_setup_model->checkPreview('fabicon');
      $fabicondata = array('name' => 'fabicon',
        'picture' => $imagef
      );
        ...
        if(!empty($checkDeata20)){
          ...
          ->update('web_pages_tbl',$fabicondata);
          
        } else {
            $this->db->insert('web_pages_tbl',$fabicondata);
        }    
      ...
      $data24 = array('name' => 'youtube_chanel_id',
              'details' => $this->input->post('youtube_chanel_id',TRUE)
              );
