...
#----------------------------------------------  
  ...
  public function save_appointment(){
        ...
        if($this->form_validation->run()==true){
            ...
            $timezone = $this->db->where('name','timezone')->get('web_pages_tbl')->row();
        ...
        $check = $this->appointment_model->Check_appointment($this->input->post('date',TRUE),$this->input->post('phone',TRUE));
