...
public function load_madicine_harbs($medicine_id){
  ...
  echo '<tr>
            ...
            <td>
                <a href="javascript:void(0);" id="re_'.$medicine_id.'"  class=" btn btn-danger btn-sm remove_button" title="Remove field">Delete</a>
            </td>
        </tr>';
}
  ...
  public function get_doctor($dpt_id=NULL)
  {
    ...
    $result = $this->db->select('
          ...
          ->join('doctor_tbl','doctor_tbl.doctor_id = hospital_doctor.doctor_id','left')
          ->join('department_tbl','department_tbl.department_id = doctor_tbl.department_id','left')
...
public function medicine_harbs_saj(){
    ...
    public function herbs_get(){
         $keyword = $this->input->get('keyword'); 
          ...
          ->from('medicine_herbs')
          ->join('herbs','herbs.herbs_id=medicine_herbs.herbs_id','left')
