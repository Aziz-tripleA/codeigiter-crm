...
*/	
	public function patient_history($patient_id)
	{
		...
		->row();
         ...
         $this->db->join('doctor_tbl', 'doctor_tbl.doctor_id = prescription_data.doctor_id','left'); 
	...
	public function patient_medical_info($patient_id=NULL){
		...
		->join('patient_tbl','patient_tbl.patient_id=patient_medical_info.patient_id','left')
